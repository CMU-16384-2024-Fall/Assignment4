...
from linear_joint_trajectory import linear_joint_trajectory
...
if __name__ == "__main__":
    ...
    goal_theta = np.array([0.0, np.pi / 2, 0.0])

    # Number of steps in the trajectory
    num_points = 100

    # Generate the trajectory
    trajectory = linear_joint_trajectory(start_theta, goal_theta, num_points)
